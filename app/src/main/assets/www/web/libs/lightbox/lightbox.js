...
Lightbox.prototype = {
    ...
    _createBoxOn: function (obj, option) {
        ...
        if (option.previmg) {
            ...
            prevLink.style.zIndex = '2070';
            self._set_cursor(prevLink);
        ...
        if (option.nextimg) {
            ...
            nextLink.style.zIndex = '2070';
            self._set_cursor(nextLink);
    ...
    _show_caption: function (enable) {
        ...
        if (caption.innerHTML.length == 0 || !enable) {
            ...
            //bolmey
            caption.style.padding = '0 7px 0 7px';
            caption.style.width = [self._img.width + 6, 'px'].join('');
        }
    },
        ...
        imag.onload = function () {
            ...
            if (caption)
                try {
                    ...
                    var parts = self._imgs[self._open].title.split('[sep]');
                    var title = "";
                    if (parts.length == 2) {
                        title = '<b>' + parts[0] + '</b></br>' + parts[1];
...
var configLightbox = {
    loadingimg: 'web/libs/lightbox/images/loading.gif',
    expandimg: 'web/libs/lightbox/images/expand.gif',
    shrinkimg: 'web/libs/lightbox/images/shrink.gif',
    blankimg: 'web/libs/lightbox/images/blank.gif',
    previmg: 'web/libs/lightbox/images/prev.gif',
    nextimg: 'web/libs/lightbox/images/next.gif',
    closeimg: 'web/libs/lightbox/images/close.gif',
    effectimg: 'web/libs/lightbox/images/zzoop.gif',
    effectpos: {x: -40, y: -20},
...
//Spica.Event.run(nsLightbox.inicio);
